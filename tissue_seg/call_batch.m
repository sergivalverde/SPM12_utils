function call_batch(image_path, options)
    ...
    SPM_SAVE_TRANSFORMATIONS = options.SPM_SAVE_TRANSFORMATIONS;

    % configure spm12 :> default config
    matlabbatch{1}.spm.spatial.preproc.channel.vols = data;
