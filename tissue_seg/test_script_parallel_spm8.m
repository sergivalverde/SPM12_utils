...
% SPM12 configuration
options.SPM_PATH = '/home/s/dev/MATLAB/libs/spm8/';
options.SPM_SAVE_TRANSFORMATIONS = 0;
...
for s=3:size(dir_names,1)
   ...
   image_properties.image_identifier = 'T1_refilled';
...
parfor (i=1:p,p)
    batch_segmentation_spm8(scans_by_thread{i,:},i, options);
end 
